...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.meui = {}, global.Vue));
  ...
  function render(_ctx, _cache, $props, $setup, $data, $options) {
    return (vue.openBlock(), vue.createBlock("div", {
      ...
      onClick: _cache[1] || (_cache[1] = (...args) => ($setup.showDropdown(...args))),
      style: $setup.style
    }, [
      ($props.ButtonText)
  ...
  var script$6 = {
      ...
      render(_ctx, _cache, $props, $setup, $data, $options) {
          ...
          const ulMenu = hasChild
              ? vue.withDirectives(vue.h("ul", { class: "nav" }, vue.renderList(data[childId], (menu) => {
                  return vue.h(_component_tree_menu, {
                      key: menu.id,
                      level: level + 1,
                      menu,
                      pidKey,
